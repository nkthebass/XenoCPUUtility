                    ...
                    case "runPathTracerBenchmark":
                        {
                            ...
                            Task.Run(() =>
                            {
                                try
                                {
                                    ...
                                    var result = pathTracer.RunBenchmark(samplesPerPixel: samplesPerPixel, imageWidth: 768, imageHeight: 768, durationSeconds: 0, numThreads: numCores, displayForm: displayForm, pictureBox: pictureBox);
